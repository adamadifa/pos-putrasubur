...
return new class extends Migration
{
    ...
    {
        Schema::create('uang_muka_supplier', function (Blueprint $table) {
            $table->id();
            $table->string('no_uang_muka', 50)->unique()->comment('Contoh: UM-SUP-20250101-001');
            $table->unsignedBigInteger('supplier_id');
            $table->date('tanggal');
            $table->decimal('jumlah_uang_muka', 15, 2)->comment('Total uang muka yang diberikan');
    ...
    {
        Schema::dropIfExists('uang_muka_supplier');
    }
};
