...
return new class extends Migration
{
    ...
    {
        // Modify enum to include UMS and UMP
    ...
    public function down(): void
    {
        ...
        DB::statement("ALTER TABLE transaksi_kas_bank MODIFY COLUMN referensi_tipe ENUM('PPJ', 'PPB', 'MN') COMMENT 'PPJ=PembayaranPenjualan, PPB=PembayaranPembelian, MN=Manual'");
    }
};
