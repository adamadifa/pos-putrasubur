...
<body class="min-h-screen bg-gray-50 text-gray-900">
    <div class="grid min-h-screen lg:grid-cols-2">
        <!-- Left panel - Blue Background with Dashboard Preview -->
        <div class="hidden lg:flex items-center justify-center p-12 bg-gradient-to-br from-blue-600 to-blue-700">
            <div class="text-center text-white max-w-lg">
                ...
                <div class="relative mb-12">
                    ...
                    <!-- Floating elements -->
                    <div class="absolute -top-4 -right-4 bg-white/10 backdrop-blur-sm rounded-xl p-3 text-xs">
                ...
                <!-- Text content -->
                <h2 class="text-3xl font-bold mb-4">Join our growing community today!</h2>
                <p class="text-blue-100 text-lg">Start your financial journey with Cointo.</p>
            </div>
        </div>
        ...
        <div class="flex items-center justify-center p-6 lg:p-12 bg-white">
            <div class="w-full max-w-sm">
                ...
                <div class="mb-8">
                    ...
                    <p class="text-sm text-gray-500">Join thousands of users managing their finances better.</p>
                </div>
