                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative group">
                                ...
                                <input type="text" name="no_rekening" id="no_rekening"
                                    value="{{ old('no_rekening', $kasBank->no_rekening) }}"
                                ...
                                <div>
                                    ...
                                    <div class="text-sm text-gray-500">
                                        ...
                                        @if (old('no_rekening', $kasBank->no_rekening))
                                            • <span
                                                id="preview-rekening">{{ old('no_rekening', $kasBank->no_rekening) }}</span>
                                        @endif
                                    </div>
                                </div>
                            </div>
