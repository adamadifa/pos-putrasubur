        ...
        <div class="flex items-center justify-between mb-6">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-500">Input data kategori baru</p>
                </div>
            </div>
        </div>
                ...
                <div class="ml-3">
                    ...
                    <div class="mt-2 text-sm text-blue-700">
                        <ul class="list-disc pl-5 space-y-1">
                            <li>Isi <strong>Nama Kategori</strong> sesuai dengan jenis produk yang akan dikelompokkan (contoh: Makanan Ringan, Minuman, Elektronik).</li>
                            <li>Pastikan nama kategori <strong>unik</strong> dan belum pernah terdaftar sebelumnya.</li>
                            <li>Klik tombol <strong>Simpan Kategori</strong> untuk menyimpan data ke sistem.</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div class="bg-gray-50 rounded-lg p-4 border border-gray-100 flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm font-semibold text-gray-900 mt-0.5" id="preview-text">Nama Kategori</p>
                        </div>
                    </div>
                </div>
