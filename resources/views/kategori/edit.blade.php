        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <div>
                                <h1
                                    ...
                                    Edit Kategori</h1>
                                <p class="text-gray-500 mt-1">Perbarui informasi kategori produk "{{ $kategori->nama }}"</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="bg-blue-50 border border-blue-200 rounded-xl p-6 mb-6">
                <div class="flex items-start">
                    ...
                    <div class="ml-3">
                        <h3 class="text-sm font-medium text-blue-800">Informasi Kategori Saat Ini</h3>
                        <div class="mt-2 text-sm text-blue-700">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <span class="font-medium">ID Kategori:</span> {{ $kategori->id }}
                                </div>
                                <div>
                                    <span class="font-medium">Nama:</span> {{ $kategori->nama }}
                                </div>
                                <div>
                        ...
                        <div class="bg-gray-50 rounded-lg p-6 border border-gray-200">
                            ...
                            <div class="flex items-center">
                                ...
                                <div>
                                    ...
                                    <div class="text-sm text-gray-500">Kategori yang diperbarui</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="flex items-start">
                    ...
                    <div class="ml-3">
                        ...
                        <div class="mt-2 text-sm text-yellow-700">
                            <ul class="list-disc pl-5 space-y-1">
                                <li>Perubahan nama kategori akan mempengaruhi semua produk dalam kategori ini</li>
                                <li>Pastikan nama baru sudah sesuai sebelum menyimpan</li>
                                <li>Kategori tidak dapat dihapus jika masih memiliki produk</li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="ml-3">
                            ...
                            <p class="text-sm text-red-700 mt-1">
                                Tindakan ini tidak dapat dibatalkan. Kategori "{{ $kategori->nama }}" akan dihapus secara
                                permanen.
                            </p>
                        </div>
                    </div>
                    <button onclick="confirmDelete({{ $kategori->id }}, '{{ $kategori->nama }}')"
                        class="inline-flex items-center justify-center w-8 h-8 bg-gradient-to-r from-red-500 to-red-600 text-white rounded-md shadow-md hover:shadow-lg hover:from-red-600 hover:to-red-700 transform hover:scale-105 transition-all duration-200 ease-out">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="w-4 h-4">
                            <path stroke-linecap="round" stroke-linejoin="round"
    ...
    <script>
            ...
            $('#editKategoriForm').on('submit', function(e) {
                ...
                if (hasErrors) {
                    ...
                    submitButton.removeClass(
                        'hover:from-orange-700 hover:to-red-700 hover:shadow-xl hover:scale-[1.02]'
                    );
                    ...
                    // Show notification
                    showNotification('Sedang mengupdate kategori...', 'info');
        ...
        function confirmDelete(id, nama) {
            Swal.fire({
                ...
                html: `Kategori <strong>"${nama}"</strong> akan dihapus secara permanen.<br><br>Tindakan ini tidak dapat dibatalkan.`,
                icon: 'warning',
