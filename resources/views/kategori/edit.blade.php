    ...
    <div class="max-w-4xl mx-auto px-4 py-6">
        ...
        <div class="flex items-center justify-between mb-6">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-500">Perbarui informasi kategori</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-blue-50 border border-blue-200 rounded-xl p-4 mb-6 shadow-sm">
            <div class="flex items-start">
                ...
                <div class="ml-3">
                    <h3 class="text-sm font-medium text-blue-800">Petunjuk Edit Kategori</h3>
                    <div class="mt-2 text-sm text-blue-700">
                        <ul class="list-disc pl-5 space-y-1">
                            <li>Ubah <strong>Nama Kategori</strong> jika terdapat kesalahan penulisan atau ingin mengganti istilah.</li>
                            <li>Perubahan nama kategori akan <strong>otomatis terupdate</strong> pada semua produk yang terkait.</li>
                            <li>Pastikan nama baru tetap <strong>unik</strong> dan tidak duplikat dengan kategori lain.</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <form action="{{ route('kategori.update', $kategori->id) }}" method="POST" id="editKategoriForm">
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div class="field-wrapper">
                        ...
                        <p class="mt-1.5 text-xs text-gray-400">Nama kategori harus unik.</p>
                    </div>
                    ...
                    <div class="bg-gray-50 rounded-lg p-4 border border-gray-100 flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm font-semibold text-gray-900 mt-0.5" id="preview-text">{{ old('nama', $kategori->nama) }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="px-6 py-4 bg-gray-50 border-t border-gray-100 flex justify-end gap-3 rounded-b-xl">
                    <a href="{{ route('kategori.index') }}" class="px-4 py-2 text-sm font-medium text-gray-600 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-200">
                        Batal
                    </a>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#nama').on('input', function() {
                var val = $(this).val();
                $('#preview-text').text(val ? val : 'Nama Kategori');
            });
