...
@section('content')
    <div class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h2 class="text-xl font-semibold text-gray-900">Laporan Penjualan</h2>
                <p class="text-sm text-gray-600">Laporan penjualan per periode dengan analisis produk dan pelanggan</p>
            </div>
        </div>
                ...
                <div class="relative">
                    ...
                    <div class="text-center mb-8 pb-6 border-b-2 border-gray-200">
                        ...
                        <div class="text-sm text-gray-600">
                            <div class="font-semibold">${penjualan.no_faktur}</div>
                            <div class="mt-1">${penjualan.tanggal} - ${penjualan.jam}</div>
                        </div>
                    </div>
                        ...
                        <div>
                            ...
                            <div class="space-y-2">
                                <div class="flex justify-between py-1">
                                    ...
                                    <span class="text-sm font-medium text-gray-900">${penjualan.pelanggan?.nama || 'Umum'}</span>
                                </div>
                                <div class="flex justify-between py-1">
                                    <span class="text-sm text-gray-600">Status:</span>
                                    <span class="inline-flex px-3 py-1 text-xs font-semibold rounded-full ${penjualan.status_pembayaran === 'lunas' ? 'bg-green-100 text-green-800 border border-green-200' : 'bg-red-100 text-red-800 border border-red-200'}">
                                        ${penjualan.status_pembayaran === 'lunas' ? 'LUNAS' : 'BELUM LUNAS'}
                                    </span>
                                </div>
                                <div class="flex justify-between py-1">
                                    <span class="text-sm text-gray-600">Jenis:</span>
                                    <span class="inline-flex px-3 py-1 text-xs font-semibold rounded-full ${penjualan.jenis_transaksi === 'tunai' ? 'bg-green-100 text-green-800' : 'bg-blue-100 text-blue-800'}">
                                        ${penjualan.jenis_transaksi.toUpperCase()}
                                    </span>
                                </div>
                            </div>
                        </div>
                        <div>
                            ...
                            <div class="space-y-2">
                                <div class="flex justify-between py-1">
                                    ...
                                    <span class="text-sm font-medium text-gray-900">Rp ${formatNumber(penjualan.total)}</span>
                                </div>
                                <div class="flex justify-between py-1">
                                    <span class="text-sm text-gray-600">Diskon:</span>
                                    <span class="text-sm font-medium text-gray-900">Rp ${formatNumber(penjualan.diskon)}</span>
                                </div>
                                <div class="flex justify-between py-2 border-t border-gray-200 mt-3">
                                    <span class="text-base font-bold text-gray-900">Total:</span>
                                    <span class="text-base font-bold text-gray-900">Rp ${formatNumber(penjualan.total_setelah_diskon)}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    ${penjualan.detail_penjualan.map(detail => `
                                                                        <tr class="hover:bg-gray-50">
                                                                            ...
                                                                            <td class="px-4 py-3 text-sm text-gray-900 text-right">Rp ${formatNumber(detail.harga)}</td>
