...
@section('title', 'Laporan Uang Muka Pelanggan')
@section('page-title', 'Laporan Uang Muka Pelanggan')

@section('content')
    <div class="max-w-7xl mx-auto space-y-6">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h2 class="text-xl font-bold text-gray-800">Laporan Uang Muka Pelanggan</h2>
                <p class="text-xs text-gray-500">Daftar penerimaan dan penggunaan uang muka pelanggan</p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200">
            ...
            <div class="p-4">
                <form method="GET" action="{{ route('laporan.uang-muka-pelanggan.index') }}">
                    ...
                    <tbody class="divide-y divide-gray-50">
                        ...
                        @forelse ($data as $index => $item)
                            ...
                            <tr class="hover:bg-gray-50/50 transition-colors">
                                ...
                                <td class="px-5 py-3">{{ $item->pelanggan->nama }}</td>
