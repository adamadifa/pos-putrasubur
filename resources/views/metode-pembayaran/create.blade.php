...
@section('content')
    <div class="max-w-4xl mx-auto px-4 py-6">
        ...
        <div class="flex items-center justify-between mb-6">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-500">Buat metode pembayaran baru</p>
                </div>
            </div>
        </div>
                ...
                <div class="ml-3">
                    ...
                    <div class="mt-2 text-sm text-blue-700">
                        <ul class="list-disc pl-5 space-y-1">
                            <li><strong>Kode</strong> harus unik dan tidak boleh ada spasi (contoh: CASH, TRANSFER).</li>
                            <li><strong>Nama</strong> metode pembayaran yang akan muncul saat transaksi.</li>
                            <li><strong>Icon</strong> menggunakan class Tabler Icons (contoh: ti-cash).</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200">
            <form action="{{ route('metode-pembayaran.store') }}" method="POST" id="createMetodeForm">
                @csrf
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div class="field-wrapper">
                        ...
                        <textarea name="deskripsi" id="deskripsi" rows="2"
                                  ...
                                  placeholder="Keterangan singkat tentang metode pembayaran ini">{{ old('deskripsi') }}</textarea>
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            // Trigger preview on load if value exists
            if ($('#icon').val()) {
                $('#icon').trigger('input');
            }
            ...
            // Form Submit
            $('#createMetodeForm').on('submit', function(e) {
                let hasErrors = false;
