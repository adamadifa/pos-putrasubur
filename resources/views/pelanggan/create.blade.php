    ...
    <div class="max-w-4xl mx-auto">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            <h1
                                ...
                                Tambah Pelanggan</h1>
                            <p class="text-gray-500 mt-1">Buat pelanggan baru untuk sistem POS Anda</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
            <div class="bg-gradient-to-r from-blue-50 to-indigo-50 px-6 py-4 border-b border-gray-100">
                <div class="flex items-center space-x-3">
                    ...
                    <h2 class="text-lg font-semibold text-gray-800">Form Tambah Pelanggan</h2>
                </div>
            </div>

            <form action="{{ route('pelanggan.store') }}" method="POST" class="p-8" id="createPelangganForm"
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative group">
                            ...
                            <input type="text" name="nama" id="nama" value="{{ old('nama') }}"
                                ...
                                placeholder="Masukkan nama lengkap pelanggan" maxlength="100">
                        </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative group">
                            ...
                            <textarea name="alamat" id="alamat" rows="3"
                                ...
                                placeholder="Masukkan alamat lengkap pelanggan" maxlength="255">{{ old('alamat') }}</textarea>
                        </div>
                        <p class="text-xs text-gray-500 flex items-center">
                            <i class="ti ti-sparkles text-xs mr-1"></i>
        ...
        <div class="bg-blue-50 border border-blue-200 rounded-xl p-6 mt-8">
            <div class="flex items-start">
                ...
                <div class="ml-3">
                    <h3 class="text-sm font-medium text-blue-800">Tips Menambah Pelanggan</h3>
                    <div class="mt-2 text-sm text-blue-700">
                        <ul class="list-disc pl-5 space-y-1">
                            <li>Pastikan data yang diisi lengkap dan akurat</li>
                            <li>Kode pelanggan bisa dikosongkan agar dibuat otomatis</li>
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            // Frontend Validation Rules and Messages (disesuaikan struktur baru)
