    ...
    <div class="max-w-4xl mx-auto px-4 py-6">
        ...
        <div class="flex items-center justify-between mb-6">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h1 class="text-xl font-bold text-gray-800">Edit Pelanggan</h1>
                    <p class="text-xs text-gray-500">Perbarui data pelanggan</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-blue-50 border border-blue-200 rounded-xl p-4 mb-6 shadow-sm">
            <div class="flex items-start">
                ...
                <div class="ml-3">
                    <h3 class="text-sm font-medium text-blue-800">Petunjuk Edit Pelanggan</h3>
                    <div class="mt-2 text-sm text-blue-700">
                        <ul class="list-disc pl-5 space-y-1">
                            <li>Ubah data yang diperlukan seperti <strong>Nama</strong>, <strong>Telepon</strong>, atau <strong>Alamat</strong>.</li>
                            <li><strong>Kode Pelanggan</strong> tetap dan tidak dapat dimodifikasi.</li>
                            <li>Biarkan field <strong>Foto Pelanggan</strong> kosong jika tidak ingin mengubah foto.</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200">
            <form action="{{ route('pelanggan.update', $pelanggan->encrypted_id) }}" method="POST" id="editPelangganForm" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="field-wrapper">
                            ...
                            <input type="text" name="nomor_telepon" id="nomor_telepon" value="{{ old('nomor_telepon', $pelanggan->nomor_telepon) }}"
                        ...
                        <div class="field-wrapper">
                            ...
                            <select name="status" id="status" class="w-full px-3 py-2 text-sm border border-gray-200 rounded-lg focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition-colors bg-gray-50/30">
                                <option value="1" {{ old('status', $pelanggan->status) == '1' ? 'selected' : '' }}>Aktif</option>
                                <option value="0" {{ old('status', $pelanggan->status) == '0' ? 'selected' : '' }}>Nonaktif</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="field-wrapper">
                        ...
                        <textarea name="alamat" id="alamat" rows="3"
                                  ...
                                  placeholder="Contoh: Jl. Sudirman No. 123">{{ old('alamat', $pelanggan->alamat) }}</textarea>
                        ...
                        <div class="flex items-center gap-4">
                            <div class="flex-shrink-0">
                                <div id="foto-preview" class="h-16 w-16 rounded-xl bg-gray-100 border border-gray-200 flex items-center justify-center overflow-hidden">
                                    @if($pelanggan->foto)
                                        <img src="{{ asset('storage/' . $pelanggan->foto) }}" class="h-full w-full object-cover">
                                    @else
                            ...
                            <div class="flex-1">
                                ...
                                <p class="mt-1 text-[10px] text-gray-400">Biarkan kosong jika tidak ingin mengubah foto. Format: JPG, PNG.</p>
                            </div>
                        </div>
                ...
                <div class="px-6 py-4 bg-gray-50 border-t border-gray-100 flex justify-end gap-3 rounded-b-xl">
                    <a href="{{ route('pelanggan.index') }}" class="px-4 py-2 text-sm font-medium text-gray-600 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-200">
                        Batal
                    </a>
