    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <p class="text-sm text-gray-600">Kelola semua pelanggan dalam sistem POS Anda</p>
            </div>
            ...
            <div
                ...
                <div class="relative p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h3 class="text-sm font-medium text-red-100">Pelanggan Nonaktif</h3>
                            ...
                            <p class="text-sm text-red-200 flex items-center mt-1">
                                ...
                                {{ $totalPelanggan > 0 ? round((($pelangganNonaktif ?? 0) / $totalPelanggan) * 100) : 0 }}%
                                dari total
                            </p>
                        </div>
                    </div>
                        ...
                        <div class="flex-1">
                            <div class="relative">
                                ...
                                <input type="text" name="search" value="{{ request('search') }}"
                                    placeholder="Cari nama pelanggan, kode, atau nomor telepon..."
                        ...
                        <tr>
                            ...
                            <th class="px-3 py-4 text-left w-64">
                                <div class="flex items-center space-x-1">
                                    <span class="text-xs font-bold text-gray-700 uppercase tracking-wider">Pelanggan</span>
                                    <i
                                    ...
                                    <div class="flex items-center">
                                        <div
                                            ...
                                            @else
                                                <div
                                                    ...
                                                    <i class="ti ti-user text-2xl text-gray-400"></i>
                                                </div>
                                            @endif
                                        </div>
                                        <div class="ml-4 flex-1">
                                            ...
                                            <div class="text-xs text-gray-500 mt-1 flex items-center space-x-2">
                                                <span
                                                    class="px-2 py-1 bg-gray-100 rounded-md font-mono text-xs">{{ $item->kode_pelanggan ?? 'P-' . str_pad($item->id, 4, '0', STR_PAD_LEFT) }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td colspan="7" class="px-6 py-12 text-center">
                                    <div class="text-gray-500">
                                        <i class="ti ti-users-off text-5xl mx-auto mb-4 text-gray-400"></i>
                                        <p class="text-lg font-medium">Tidak ada pelanggan ditemukan</p>
                                        <p class="text-sm">Coba ubah filter pencarian atau tambah pelanggan baru</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
                    ...
                    <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                        <div>
                            <p class="text-sm text-gray-700">
                                Menampilkan <span class="font-medium">{{ $pelanggan->firstItem() ?? 0 }}</span> sampai
                                <span class="font-medium">{{ $pelanggan->lastItem() ?? 0 }}</span> dari
                                <span class="font-medium">{{ $pelanggan->total() }}</span> pelanggan
                            </p>
                        </div>
                        <div>
                            {{ $pelanggan->links() }}
