    ...
    <div class="min-h-screen py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-xl shadow-lg border border-gray-100">
                <form action="{{ route('pengaturan-umum.update', $pengaturanUmumModel) }}" method="POST" enctype="multipart/form-data"
                    id="pengaturanForm">
                    @csrf
                    @method('PUT')
                    <div class="p-8 space-y-8">
                                ...
                                <div class="space-y-3">
                                    ...
                                    <div class="relative group">
                                        ...
                                        <input type="text" name="nama_toko" id="nama_toko"
                                            ...
                                            placeholder="Masukkan nama toko" value="{{ old('nama_toko', $pengaturanUmumModel->nama_toko) }}">
                                    </div>
                                    @error('nama_toko')
                                ...
                                <div class="space-y-3">
                                    ...
                                    <div class="relative group">
                                        ...
                                        <input type="text" name="no_telepon" id="no_telepon"
                                            ...
                                            placeholder="Contoh: 081234567890" value="{{ old('no_telepon', $pengaturanUmumModel->no_telepon) }}">
                                    </div>
                                    @error('no_telepon')
                                        <p class="mt-2 text-sm text-red-600 flex items-center">
                                            <i class="ti ti-alert-circle text-red-500 mr-1"></i>
                                ...
                                <div class="space-y-3">
                                    ...
                                    <div class="relative group">
                                        ...
                                        <input type="text" name="no_rekening_koperasi" id="no_rekening_koperasi"
                                            ...
                                            value="{{ old('no_rekening_koperasi', $pengaturanUmumModel->no_rekening_koperasi) }}">
                                    </div>
                                ...
                                <div class="space-y-3">
                                    ...
                                    <div class="relative group">
                                        ...
                                        <input type="email" name="email" id="email"
                                            ...
                                            placeholder="Contoh: info@tokosaya.com" value="{{ old('email', $pengaturanUmumModel->email) }}">
                                    </div>
                                    @error('email')
                                        <p class="mt-2 text-sm text-red-600 flex items-center">
                                            <i class="ti ti-alert-circle text-red-500 mr-1"></i>
                                        ...
                                        <div class="flex items-center space-x-4">
                                            <div class="relative group">
                                                ...
                                                <div
                                                    ...
                                                    <span class="text-white text-xs font-medium bg-black/50 px-2 py-1 rounded-full">Logo
                                                        Aktif</span>
                                                </div>
                                            </div>
                                            <div class="flex-1">
                        ...
                        <div class="bg-gradient-to-br from-orange-50 to-amber-50 rounded-xl p-8 border border-orange-100">
                            ...
                            <div class="space-y-4">
                                <!-- Current Foto Toko -->
                                @if ($pengaturanUmumModel->foto_toko)
                                    <div class="bg-white rounded-xl border border-gray-200 p-6 mb-4">
                                        <h4 class="font-semibold text-gray-900 mb-3">Foto Toko Saat Ini</h4>
                                        <div class="flex items-center space-x-4">
                                            <img src="{{ $pengaturanUmumModel->foto_toko_url }}" alt="Foto Toko Saat Ini"
                                                class="w-32 h-24 object-cover rounded-xl border-2 border-gray-100 shadow-sm">
                                            <div class="flex-1">
                                                <p class="text-sm text-gray-600">Foto toko yang sedang digunakan</p>
                                            </div>
                                        </div>
                                    </div>
                                @endif
                                ...
                                <div
                                    ...
                                    <div class="space-y-2">
                                        <p class="text-lg font-semibold text-gray-900">Upload Foto Toko Baru</p>
                                        <p class="text-sm text-gray-600">Drag & drop atau klik untuk memilih file</p>
                                        <div class="text-xs text-gray-500 space-y-1">
                                            <p><i class="ti ti-check text-green-500 mr-1"></i>Format: JPEG, PNG, JPG, GIF
                                            </p>
                                ...
                                <div id="fotoTokoPreview" class="hidden">
                                    <div class="bg-white rounded-xl border border-gray-200 p-6">
                                        <div class="flex items-center space-x-4">
                                            ...
                                            <div class="flex-1">
                                                <h4 class="font-semibold text-gray-900">Preview Foto Toko Baru</h4>
                                                <p class="text-sm text-gray-600">Foto baru akan menggantikan foto saat ini
                                                </p>
                                            </div>
                                        </div>
                                    </div>
