...
@section('page-title', 'Edit Penyesuaian Stok')
    ...
    <div class="max-w-7xl mx-auto px-4 py-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h1 class="text-xl font-bold text-gray-800">Edit Penyesuaian</h1>
                    <p class="text-xs text-gray-500">Perbarui data penyesuaian stok</p>
                </div>
            </div>
            <div class="mt-4 sm:mt-0">
                <span class="inline-flex items-center px-3 py-1 rounded-lg bg-blue-50 text-blue-700 text-xs font-bold border border-blue-100">
                    <i class="ti ti-clipboard-list mr-1"></i> {{ $penyesuaianStok->kode_penyesuaian }}
                </span>
            </div>
        </div>
                ...
                <div class="p-6 space-y-8">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <!-- Stok Saat Ini -->
                            <div class="space-y-1">
                                <label class="block text-xs font-bold text-gray-500">Stok Saat Ini (Sistem)</label>
                                <div class="relative">
                            ...
                            <div class="space-y-1">
                                ...
                                <div class="relative">
                                    <input type="text" name="jumlah_penyesuaian" id="jumlah_penyesuaian"
                                        value="{{ old('jumlah_penyesuaian', number_format($penyesuaianStok->jumlah_penyesuaian, 2, ',', '.')) }}"
                            ...
                            <!-- Stok Akhir -->
                            <div class="space-y-1">
                                <label class="block text-xs font-bold text-gray-700">Stok Akhir (Estimasi)</label>
                                <div class="relative">
                    ...
                    <div class="space-y-1">
                        ...
                        <textarea name="keterangan" id="keterangan" rows="3"
                            ...
                            placeholder="Alasan penyesuaian stok (min. 10 karakter)">{{ old('keterangan', $penyesuaianStok->keterangan) }}</textarea>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('penyesuaianForm').addEventListener('submit', function(e) {
                ...
                if(!isValid) {
                    ...
                    // Revert visual if submit is cancelled/fails quickly
                    setTimeout(() => { 
