        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <div>
                                <h1
                                    ...
                                    Tambah Satuan Baru</h1>
                                <p class="text-gray-500 mt-1">Buat satuan produk baru untuk mengukur produk</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
                <div class="bg-gradient-to-r from-blue-50 to-indigo-50 px-6 py-4 border-b border-gray-100">
                    <div class="flex items-center space-x-3">
                        ...
                        <h2 class="text-lg font-semibold text-gray-800">Form Tambah Satuan</h2>
                    </div>
                </div>

                <form action="{{ route('satuan.store') }}" method="POST" class="p-8" id="createSatuanForm">
                    @csrf
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative group">
                                ...
                                <input type="text" name="nama" id="nama" value="{{ old('nama') }}"
                                    ...
                                    placeholder="Contoh: Kilogram, Liter, Pcs, dll" maxlength="50">
                            </div>
                            ...
                            <div class="flex items-center">
                                ...
                                <div>
                                    <div class="text-base font-medium text-gray-900" id="preview-nama">
                                        {{ old('nama') ?: 'Nama Satuan' }}
                                    </div>
                                    <div class="text-sm text-gray-500">Satuan baru</div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="bg-blue-50 border border-blue-200 rounded-xl p-6 mt-8">
                <div class="flex items-start">
                    ...
                    <div class="ml-3">
                        <h3 class="text-sm font-medium text-blue-800">Tips Membuat Satuan</h3>
                        <div class="mt-2 text-sm text-blue-700">
                            <ul class="list-disc pl-5 space-y-1">
                                <li>Gunakan nama yang singkat dan jelas</li>
                                <li>Hindari nama yang terlalu spesifik atau terlalu umum</li>
                                <li>Pertimbangkan kemudahan pengguna dalam memahami ukuran produk</li>
                                <li>Satuan dapat diedit nanti jika diperlukan</li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        $(document).ready(function() {
            ...
            $('#createSatuanForm').on('submit', function(e) {
                ...
                if (hasErrors) {
                    ...
                    // Show notification
                    showNotification('Sedang menyimpan satuan...', 'info');
