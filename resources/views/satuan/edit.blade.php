        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <div>
                                <h1
                                    ...
                                    Edit Satuan</h1>
                                <p class="text-gray-500 mt-1">Perbarui informasi satuan produk yang sudah ada</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
                <div class="bg-gradient-to-r from-blue-50 to-indigo-50 px-6 py-4 border-b border-gray-100">
                    <div class="flex items-center space-x-3">
                        ...
                        <h2 class="text-lg font-semibold text-gray-800">Form Edit Satuan</h2>
                    </div>
                </div>

                <form action="{{ route('satuan.update', $satuan->id) }}" method="POST" class="p-8"
                    id="editSatuanForm">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="space-y-8">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative group">
                                ...
                                <input type="text" name="nama" id="nama"
                                    ...
                                    placeholder="Contoh: Kilogram, Liter, Pcs, dll" maxlength="50" required>
                            </div>
                            <p class="text-xs text-gray-500 flex items-center">
                                ...
                                Berikan nama yang jelas dan mudah dipahami untuk satuan ini
                            </p>
                            @error('nama')
                        ...
                        <div class="bg-gray-50 rounded-lg p-6 border border-gray-200">
                            <h4 class="text-sm font-semibold text-gray-700 mb-4">Preview Satuan</h4>
                            <div class="flex items-center">
                                <div
                                ...
                                <div>
                                    <div class="text-base font-medium text-gray-900" id="preview-nama">
                                        {{ old('nama', $satuan->nama) ?: 'Nama Satuan' }}
                                    </div>
                                    <div class="text-sm text-gray-500">Satuan yang diperbarui</div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="bg-blue-50 border border-blue-200 rounded-xl p-6 mt-8">
                <div class="flex items-start">
                    ...
                    <div class="ml-3">
                        <h3 class="text-sm font-medium text-blue-800">Tips Mengedit Satuan</h3>
                        <div class="mt-2 text-sm text-blue-700">
                            <ul class="list-disc pl-5 space-y-1">
                                <li>Pastikan nama satuan tetap konsisten dengan produk yang ada</li>
                                <li>Hindari perubahan yang dapat membingungkan pengguna</li>
                                <li>Pertimbangkan dampak perubahan pada produk yang terkait</li>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#nama').on('input', function() {
                ...
                previewNama.text(this.value || 'Nama Satuan');
            });
            ...
            $('#editSatuanForm').on('submit', function(e) {
                ...
                if (hasErrors) {
                    ...
                    // Show notification
                    showNotification('Sedang memperbarui satuan...', 'info');
            ...
            function showNotification(message, type = 'info') {
                ...
                switch (type) {
                    ...
                    default:
                        bgColor = 'bg-blue-500';
                        icon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 mr-2">
                              <path stroke-linecap="round" stroke-linejoin="round" d="M11.25 11.25l.041-.20a.75.75 0 011.063.852l-.708 2.836a.75.75 0 001.063.853l.041-.021M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-9-3.75h.008v.008H12v-.008z" />
                            </svg>`;
                }
