    ...
    <div class="max-w-4xl mx-auto px-4 py-6">
        ...
        <div class="flex items-center justify-between mb-6">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h1 class="text-xl font-bold text-gray-800">Edit Satuan</h1>
                    <p class="text-xs text-gray-500">Perbarui informasi satuan produk</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-blue-50 border border-blue-200 rounded-xl p-4 mb-6 shadow-sm">
            <div class="flex items-start">
                ...
                <div class="ml-3">
                    <h3 class="text-sm font-medium text-blue-800">Petunjuk Edit Satuan</h3>
                    <div class="mt-2 text-sm text-blue-700">
                        <ul class="list-disc pl-5 space-y-1">
                            <li>Ubah <strong>Nama Satuan</strong> jika terdapat kesalahan penulisan.</li>
                            <li>Perubahan nama satuan akan <strong>otomatis terupdate</strong> pada semua produk yang terkait.</li>
                            <li>Pastikan nama baru tetap <strong>unik</strong> dan tidak duplikat.</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200">
            <form action="{{ route('satuan.update', $satuan->id) }}" method="POST" id="editSatuanForm">
                @csrf
                @method('PUT')
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div class="field-wrapper">
                        ...
                        <input type="text" name="nama" id="nama" value="{{ old('nama', $satuan->nama) }}"
                    ...
                    <div class="bg-gray-50 rounded-lg p-4 border border-gray-100 flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm font-semibold text-gray-900 mt-0.5" id="preview-text">{{ old('nama', $satuan->nama) }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="px-6 py-4 bg-gray-50 border-t border-gray-100 flex justify-end gap-3 rounded-b-xl">
                    <a href="{{ route('satuan.index') }}" class="px-4 py-2 text-sm font-medium text-gray-600 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-200">
                        Batal
                    </a>
