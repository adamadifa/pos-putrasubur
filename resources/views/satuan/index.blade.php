...
@section('content')
    <div class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                <h2 class="text-xl font-bold text-gray-900">Daftar Satuan</h2>
                <p class="text-sm text-gray-500">Kelola satuan untuk unit produk</p>
            </div>
            <div>
                    ...
                    <div class="flex items-center">
                        <div class="flex-shrink-0">
                            <div
                                ...
                                <i class="ti ti-ruler text-2xl text-white"></i>
                            </div>
                        </div>
                        <div class="ml-4">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-3">
                        <div class="p-2 bg-primary-50 rounded-lg">
                            <i class="ti ti-ruler text-xl text-primary-600"></i>
                        </div>
                        <div>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th scope="col" class="px-3 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Nama Satuan</th>
                           ...
                           <!-- Number -->
                            ...
                            <td class="px-3 py-3 whitespace-nowrap text-right pl-6">
                                <div class="flex items-center justify-end gap-2">
                                    ...
                                    <button type="button" 
                                            onclick="confirmDelete({{ $satuan->id }}, '{{ $satuan->nama }}')"
                             ...
                             <td colspan="5" class="px-6 py-12 text-center text-gray-500 bg-gray-50/50">
                                <div class="flex flex-col items-center justify-center">
                                    <div class="p-3 bg-gray-100 rounded-full mb-3">
                                        <i class="ti ti-ruler-off text-2xl text-gray-400"></i>
                                    </div>
                                    <p class="text-sm font-medium">Belum ada satuan</p>
                                    <p class="text-xs text-gray-400 mt-1">Tambahkan satuan baru untuk memulai</p>
                                </div>
                            </td>
                        </tr>
                        @endforelse
...
@push('scripts')
    ...
    <script>
        function confirmDelete(id, name) {
            Swal.fire({
                title: 'Hapus Satuan?',
                text: `Hapus "${name}"? Produk dengan satuan ini mungkin akan terpengaruh.`,
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    ...
                    form.method = 'POST';
                    form.action = `{{ route('satuan.destroy', '') }}/${id}`;
