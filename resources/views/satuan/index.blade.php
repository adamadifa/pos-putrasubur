...
@section('page-title', 'Kelola Satuan Produk')
...
@section('content')
    <div class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h2 class="text-xl font-semibold text-gray-900">Daftar Satuan Produk</h2>
                <p class="text-sm text-gray-600">Kelola semua satuan produk dalam sistem POS Anda</p>
            </div>
                    ...
                    <div class="flex items-center">
                        <div class="flex-shrink-0">
                            <div
                                ...
                                <i class="ti ti-ruler text-xl text-white"></i>
                            </div>
                        </div>
                        <div class="ml-4">
                            <h3 class="text-sm font-medium text-purple-100">Total Satuan</h3>
                            <p class="text-3xl font-bold text-white">{{ $totalSatuan }}</p>
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-3">
                        <div class="p-2 bg-primary-50 rounded-lg">
                            <i class="ti ti-ruler text-lg text-primary-600"></i>
                        </div>
                        <div>
                            <h3 class="text-lg font-semibold text-gray-900">Daftar Satuan</h3>
                            <p class="text-sm text-gray-500">Menampilkan {{ $satuans->count() }} dari
                                {{ $totalSatuan }} satuan</p>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div
                                                ...
                                                <i class="ti ti-ruler text-xl text-purple-600"></i>
                                            </div>
                                            <div>
                                                <div class="text-sm font-medium text-gray-900">{{ $satuan->nama }}</div>
                                                <div class="text-xs text-gray-500">ID: {{ $satuan->id }}</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <span
                                                ...
                                                <i class="ti ti-box text-sm mr-1"></i>
                                                {{ $satuan->produk_count }} produk
                                            </span>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <div class="flex items-center justify-center space-x-1">
                                            ...
                                            <!-- Delete Button -->
                                            <button onclick="confirmDelete({{ $satuan->id }}, '{{ $satuan->nama }}')"
            ...
            @else
                <div class="text-center py-12">
                    <div class="w-16 h-16 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-4">
                        <i class="ti ti-box text-3xl text-gray-400"></i>
                    </div>
                    <h3 class="text-lg font-medium text-gray-900 mb-2">Belum ada satuan</h3>
                    <p class="text-gray-500 mb-6">Mulai dengan menambahkan satuan produk pertama Anda</p>
                    <a href="{{ route('satuan.create') }}"
                        class="inline-flex items-center px-4 py-2 bg-primary-600 border border-transparent rounded-lg font-medium text-sm text-white hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-colors">
