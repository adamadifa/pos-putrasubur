    ...
    <div class="max-w-4xl mx-auto px-4 py-6">
        ...
        <div class="flex items-center justify-between mb-6">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h1 class="text-xl font-bold text-gray-800">Tambah Supplier</h1>
                    <p class="text-xs text-gray-500">Input data pemasok baru</p>
                </div>
            </div>
        </div>
                ...
                <div class="ml-3">
                    ...
                    <div class="mt-2 text-sm text-blue-700">
                        <ul class="list-disc pl-5 space-y-1">
                            <li><strong>Kode Supplier</strong> akan dibuat otomatis oleh sistem setelah disimpan.</li>
                            <li>Lengkapi data <strong>Nama</strong>, <strong>Telepon</strong>, dan <strong>Alamat</strong>.</li>
                            <li>Pastikan status diset ke <strong>Aktif</strong> agar supplier dapat digunakan dalam transaksi.</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200">
            <form action="{{ route('supplier.store') }}" method="POST" id="createSupplierForm">
                @csrf
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div class="field-wrapper">
                        ...
                        <textarea name="alamat" id="alamat" rows="2"
                                  ...
                                  placeholder="Contoh: Jl. Industri Raya No. 99, Jakarta Barat">{{ old('alamat') }}</textarea>
                    ...
                    <div class="field-wrapper">
                        ...
                        <textarea name="keterangan" id="keterangan" rows="2"
                                  ...
                                  placeholder="Tambahan catatan (opsional)">{{ old('keterangan') }}</textarea>
