    ...
    <div class="max-w-4xl mx-auto">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            <h1
                                ...
                                Edit Supplier</h1>
                            <p class="text-gray-500 mt-1">Edit data supplier {{ $supplier->nama }}</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
            <div class="bg-gradient-to-r from-blue-50 to-indigo-50 px-6 py-4 border-b border-gray-100">
                <div class="flex items-center space-x-3">
                    ...
                    <h2 class="text-lg font-semibold text-gray-800">Form Edit Supplier</h2>
                </div>
            </div>

            <form action="{{ route('supplier.update', $supplier->encrypted_id) }}" method="POST" class="p-8"
                id="editSupplierForm" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="space-y-8">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative group">
                            ...
                            <input type="text" name="kode_supplier" id="kode_supplier"
                                ...
                                placeholder="Contoh: SUP001" maxlength="20" required>
                        </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative group">
                            ...
                            <input type="text" name="nama" id="nama" value="{{ old('nama', $supplier->nama) }}"
                                ...
                                placeholder="Masukkan nama supplier" maxlength="100" required>
                        </div>
                        <p class="text-xs text-gray-500 flex items-center">
                            <i class="ti ti-sparkles text-xs mr-1"></i>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative group">
                            ...
                            <select name="status" id="status"
                                ...
                                <option value="1"
                                    {{ old('status', $supplier->status ? '1' : '0') == '1' ? 'selected' : '' }}>Aktif
                                </option>
                                <option value="0"
                                    {{ old('status', $supplier->status ? '1' : '0') == '0' ? 'selected' : '' }}>Nonaktif
                                </option>
                            </select>
                        </div>
                        @error('status')
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative group">
                            ...
                            <textarea name="alamat" id="alamat" rows="3"
                                ...
                                placeholder="Masukkan alamat lengkap supplier" maxlength="255">{{ old('alamat', $supplier->alamat) }}</textarea>
                        </div>
                        <p class="text-xs text-gray-500 flex items-center">
                            <i class="ti ti-sparkles text-xs mr-1"></i>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative group">
                            ...
                            <textarea name="keterangan" id="keterangan" rows="3"
                                ...
                                placeholder="Tambahkan keterangan tambahan tentang supplier" maxlength="255">{{ old('keterangan', $supplier->keterangan) }}</textarea>
                        </div>
                        <p class="text-xs text-gray-500 flex items-center">
                            <i class="ti ti-sparkles text-xs mr-1"></i>
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 border border-gray-200">
                        ...
                        <div class="flex items-center">
                            ...
                            <div>
                                <div class="text-base font-medium text-gray-900" id="preview-nama">{{ $supplier->nama }}
                                </div>
                                <div class="text-sm text-gray-500" id="preview-kode">Kode: {{ $supplier->kode_supplier }}
                                </div>
                                <div class="text-sm text-gray-500" id="preview-phone">
                                    {{ $supplier->telepon ?? '08123456789' }}</div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="bg-blue-50 border border-blue-200 rounded-xl p-6 mt-8">
            <div class="flex items-start">
                ...
                <div class="ml-3">
                    <h3 class="text-sm font-medium text-blue-800">Tips Edit Supplier</h3>
                    <div class="mt-2 text-sm text-blue-700">
                        <ul class="list-disc pl-5 space-y-1">
                            <li>Pastikan data yang diubah tetap akurat dan lengkap</li>
                            <li>Kode supplier harus unik dan tidak boleh kosong</li>
                            <li>Status aktif/nonaktif mempengaruhi akses supplier</li>
                            <li>Email dan nomor telepon opsional untuk komunikasi</li>
                            <li>Alamat dan keterangan opsional untuk informasi tambahan</li>
                        </ul>
                    </div>
                </div>
            </div>
