...
@section('content')
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <div>
                                <h1
                                    ...
                                    Tambah Transaksi Kas & Bank</h1>
                                <p class="text-gray-500 mt-1">Buat transaksi baru untuk kas atau bank</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
                <div class="bg-gradient-to-r from-blue-50 to-indigo-50 px-6 py-4 border-b border-gray-100">
                    <div class="flex items-center space-x-3">
                        ...
                        <h2 class="text-lg font-semibold text-gray-800">Form Tambah Transaksi</h2>
                    </div>
                </div>

                <form action="{{ route('transaksi-kas-bank.store') }}" method="POST" class="p-8"
                    id="createTransaksiForm">
                    @csrf
                            ...
                            <div class="grid grid-cols-2 gap-3">
                                <label
                                    ...
                                    <input type="radio" name="jenis_transaksi" value="D"
                                        {{ old('jenis_transaksi', 'D') === 'D' ? 'checked' : '' }}
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative group">
                                ...
                                <textarea name="keterangan" id="keterangan" rows="3"
                                    ...
                                    placeholder="Masukkan keterangan transaksi (opsional)" maxlength="255">{{ old('keterangan') }}</textarea>
                            </div>
                            <p class="text-xs text-gray-500 flex items-center">
                                <i class="ti ti-info-circle text-gray-400 mr-1"></i>
            ...
            <div class="bg-blue-50 border border-blue-200 rounded-xl p-6 mt-8">
                <div class="flex items-start">
                    ...
                    <div class="ml-3">
                        <h3 class="text-sm font-medium text-blue-800">Tips Membuat Transaksi Kas & Bank</h3>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#createTransaksiForm').on('submit', function(e) {
                let hasErrors = false;
