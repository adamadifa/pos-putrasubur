                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <div>
                                <h1
                                    ...
                                    Tambah Transaksi Kas & Bank
                                </h1>
                                <p class="text-gray-500 mt-1">Input transaksi kas dan bank baru</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
                <div class="bg-gradient-to-r from-blue-50 to-indigo-50 px-6 py-4 border-b border-gray-100">
                    <div class="flex items-center space-x-3">
                        ...
                        <h2 class="text-lg font-semibold text-gray-800">Form Transaksi Kas & Bank</h2>
                    </div>
                </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative group">
                                    ...
                                    <input type="text" name="tanggal" id="tanggal" readonly
                                        value="{{ old('tanggal', date('d/m/Y')) }}" placeholder="Pilih tanggal"
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <label class="relative cursor-pointer transaction-type-option">
                                    <input type="radio" name="jenis_transaksi" id="jenis_transaksi_masuk"
                                        value="D" {{ old('jenis_transaksi') == 'D' ? 'checked' : '' }}
                                ...
                                <label class="relative cursor-pointer transaction-type-option">
                                    <input type="radio" name="jenis_transaksi" id="jenis_transaksi_keluar"
                                        value="K" {{ old('jenis_transaksi') == 'K' ? 'checked' : '' }}
                                        class="sr-only transaction-type-radio">
                                    <div
