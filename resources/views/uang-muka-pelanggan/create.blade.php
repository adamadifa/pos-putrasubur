...
@section('title', 'Tambah Uang Muka Pelanggan')
@section('page-title', 'Tambah Uang Muka Pelanggan Baru')
...
@section('content')
    <div class="max-w-4xl mx-auto">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            <h1 class="text-2xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent">
                                Tambah Uang Muka Pelanggan
                            </h1>
                            <p class="text-gray-500 mt-1">Input uang muka yang diterima dari pelanggan</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
            ...
            <form action="{{ route('uang-muka-pelanggan.store') }}" method="POST" class="p-8">
                @csrf
                <div class="space-y-6">
                    <!-- Pelanggan -->
                    <div>
                        <label for="pelanggan_id" class="block text-sm font-semibold text-gray-700 mb-2">
