    ...
    <div class="max-w-4xl mx-auto px-4 py-6">
        ...
        <div class="flex items-center justify-between mb-6">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h1 class="text-xl font-bold text-gray-800">Tambah User</h1>
        ...
        <div class="bg-blue-50 border border-blue-200 rounded-xl p-4 mb-6 shadow-sm">
            <div class="flex items-start">
                ...
                <div class="ml-3">
                    <h3 class="text-sm font-medium text-blue-800">Petunjuk Pembuatan User</h3>
                    <div class="mt-2 text-sm text-blue-700">
                        <ul class="list-disc pl-5 space-y-1">
                            <li><strong>Email</strong> harus valid dan belum terdaftar.</li>
                            <li><strong>Role</strong> menentukan hak akses user (Admin/Kasir/Manager).</li>
    ...
    <script>
        $(document).ready(function() {
            ...
            const validationMessages = {
                ...
                password_confirmation: { required: 'Konfirmasi password wajib diisi.', match: 'Password tidak cocok.' }
            };
            ...
            fieldsToValidate.forEach(function(fieldName) {
                ...
                field.on('input change blur', function() {
                    ...
                    // Skip simple required check on input if empty
